...
ActiveRecord::Schema.define(:version => 20120301153455) do
  ...
  create_table "code_categories", :force => true do |t|
    t.string "type"
    t.string "name"
  end

  create_table "code_documents", :force => true do |t|
  ...
  create_table "custom_fields_roles", :primary_key => "custom_field_id", :force => true do |t|
  ...
  create_table "kb_article_versions", :force => true do |t|
    t.integer  "kb_article_id"
    t.integer  "version"
    t.integer  "category_id"
    t.string   "title"
    t.text     "summary"
    ...
    t.string   "version_comments", :default => ""
  end
  ...
  create_table "queries_roles", :primary_key => "query_id", :force => true do |t|
    t.integer "role_id", :null => false
  end
